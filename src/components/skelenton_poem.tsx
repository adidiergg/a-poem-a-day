...
export function SkeletonPoem() {
  return (
    <Skeleton className="z-0 flex h-fit min-h-[calc(100vh-96px)]  w-full rounded-lg bg-background/40  ">
      <div className="flex basis-full flex-col justify-between gap-4 p-8 md:px-12">
        ...
        <div className="h-64 w-full rounded-sm bg-primary/20 lg:basis-full">
          {" "}
        </div>
      </div>
    </Skeleton>
